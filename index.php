...
<head>
    ...
    <title>Pawfect Home - Dog Adoption Center</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Find Your Best Furry Companion</h1>
    ...
    <section class="featured-dogs">
        <div class="container">
            ...
            <div class="dogs-grid" id="featuredDogs">
                ...
                error_log("Featured dogs count: " . count($featured_dogs));
                
                if (empty($featured_dogs)): 
                ?>
                    <div class="no-dogs" style="grid-column: 1 / -1; text-align: center; padding: 3rem;">
                        <i class="fas fa-paw" style="font-size: 3rem; color: #ccc; margin-bottom: 1rem;"></i>
                        <p style="color: #666; margin-bottom: 1.5rem;">No dogs available at the moment. Please check back later.</p>
                        <?php if (is_admin()): ?>
                    ...
                    <?php foreach ($featured_dogs as $dog): ?>
                        <div class="dog-card">
                            ...
                            <div class="dog-info">
                                ...
                                <p class="dog-description"><?php echo htmlspecialchars(substr($dog['description'] ?? 'Loving companion looking for a home', 0, 100)) . '...'; ?></p>
                                <div class="dog-actions">
                                    <a href="pages/dog_details.php?id=<?php echo $dog['dog_id']; ?>" class="btn btn-outline">View Details</a>
                                    <?php if ($is_logged_in && $user_role === 'user' && ($dog['status'] ?? '') === 'available'): ?>
